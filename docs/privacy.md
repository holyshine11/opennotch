...
- The optional “Open the menu for me” helper uses the macOS Accessibility permission only to open the browser menu you asked for (in Safari, to turn that setting on in Safari Settings); nothing on your screen is read or recorded, and you can turn it off any time in System Settings.
